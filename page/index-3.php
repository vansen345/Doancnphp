                        ...
                        <div class="swiper-container product-default-slider-4grid-2row">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="product-default-single-item product-color--pink swiper-slide">
                                    ...
                                    <div class="content">
                                        <div class="content-left">
                                            <h6 class="title"><a href="../page/product-details-default.php">Aliquam lobortis</a></h6>
                                ...
                                <div class="product-default-single-item product-color--pink swiper-slide">
                                    ...
                                    <div class="content">
                                        <div class="content-left">
                                            <h6 class="title"><a href="../page/product-details-default.php">Condimentum posuere</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                ...
                                <div class="product-default-single-item product-color--pink swiper-slide">
                                    ...
                                    <div class="content">
                                        <div class="content-left">
                                            <h6 class="title"><a href="../page/product-details-default.php">Cras neque metus</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                ...
                                <div class="product-default-single-item product-color--pink swiper-slide">
                                    ...
                                    <div class="content">
                                        <div class="content-left">
                                            <h6 class="title"><a href="../page/product-details-default.php">Donec eu libero ac</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                ...
                                <div class="product-default-single-item product-color--pink swiper-slide">
                                    ...
                                    <div class="content">
                                        <div class="content-left">
                                            <h6 class="title"><a href="../page/product-details-default.php">Kaoreet lobortis sagit</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                ...
                                <div class="product-default-single-item product-color--pink swiper-slide">
                                    ...
                                    <div class="content">
                                        <div class="content-left">
                                            <h6 class="title"><a href="../page/product-details-default.php">Convallis quam sit</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                ...
                                <div class="product-default-single-item product-color--pink swiper-slide">
                                    ...
                                    <div class="content">
                                        <div class="content-left">
                                            <h6 class="title"><a href="../page/product-details-default.php">Dolorum fuga eget</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                ...
                                <div class="product-default-single-item product-color--pink swiper-slide">
                                    ...
                                    <div class="content">
                                        <div class="content-left">
                                            <h6 class="title"><a href="../page/product-details-default.php">Duis pulvinar obortis</a></h6>
                                            <ul class="review-star">
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                                                <li class="fill"><i class="ion-android-star"></i></li>
                        ...
                        <div class="swiper-container blog-slider">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="blog-default-single-item blog-color--pink swiper-slide">
                                    <div class="image-box">
                                        <a href="../page/blog-full-width.php" class="image-link">
                                            <img class="img-fluid" src="../images/blog/blog-grid-home-1-img-1.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="../page/blog-full-width.php">Blog Post One</a></h6>
                                        ...
                                        <div class="inner">
                                            <a href="../page/blog-full-width.php" class="read-more-btn icon-space-left">Read More <span><i class="ion-ios-arrow-thin-right"></i></span></a>
                                            <div class="post-meta">
                                ...
                                <div class="blog-default-single-item blog-color--pink swiper-slide">
                                    ...
                                    <div class="content">
                                        <h6 class="title"><a href="../page/blog-full-width.php">Blog Post Two</a></h6>
                                        <p>Donec vitae hendrerit arcu, sit amet faucibus nisl. Cras pretium arcu ex. Aenean posuere libero eu augue condimentum rhoncus. Praesent</p>
                                        <div class="inner">
                                            <a href="#" class="read-more-btn icon-space-left">Read More <span><i class="ion-ios-arrow-thin-right"></i></span></a>
                                            <div class="post-meta">
                                                <a href="../page/blog-full-width.php" class="date">24 Apr</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="blog-default-single-item blog-color--pink swiper-slide">
                                    <div class="image-box">
                                        <a href="../page/blog-full-width.php" class="image-link">
                                            <img class="img-fluid" src="../images/blog/blog-grid-home-1-img-3.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="../page/blog-full-width.php">Blog Post Three</a></h6>
                                        <p>Donec vitae hendrerit arcu, sit amet faucibus nisl. Cras pretium arcu ex. Aenean posuere libero eu augue condimentum rhoncus. Praesent</p>
                                        <div class="inner">
                                            <a href="../page/blog-full-width.php" class="read-more-btn icon-space-left">Read More <span><i class="ion-ios-arrow-thin-right"></i></span></a>
                                            <div class="post-meta">
                                ...
                                <div class="blog-default-single-item blog-color--pink swiper-slide">
                                    <div class="image-box">
                                        <a href="../page/blog-full-width.php" class="image-link">
                                            <img class="img-fluid" src="../images/blog/blog-grid-home-1-img-4.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="../page/blog-full-width.php">Blog Post Four</a></h6>
                                        <p>Donec vitae hendrerit arcu, sit amet faucibus nisl. Cras pretium arcu ex. Aenean posuere libero eu augue condimentum rhoncus. Praesent</p>
                                        <div class="inner">
                                            <a href="../page/blog-full-width.php" class="read-more-btn icon-space-left">Read More <span><i class="ion-ios-arrow-thin-right"></i></span></a>
                                            <div class="post-meta">
                                ...
                                <div class="blog-default-single-item blog-color--pink swiper-slide">
                                    ...
                                    <div class="content">
                                        <h6 class="title"><a href="../page/blog-full-width.php">Blog Post Five</a></h6>
                                        <p>Donec vitae hendrerit arcu, sit amet faucibus nisl. Cras pretium arcu ex. Aenean posuere libero eu augue condimentum rhoncus. Praesent</p>
                                        <div class="inner">
                                            <a href="../page/blog-full-width.php" class="read-more-btn icon-space-left">Read More <span><i class="ion-ios-arrow-thin-right"></i></span></a>
                                            <div class="post-meta">
                                ...
                                <div class="blog-default-single-item blog-color--pink swiper-slide">
                                    <div class="image-box">
                                        <a href="../page/blog-full-width.php" class="image-link">
                                            <img class="img-fluid" src="../images/blog/blog-grid-home-1-img-6.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="../page/blog-full-width.php">Blog Post Six</a></h6>
                                        <p>Donec vitae hendrerit arcu, sit amet faucibus nisl. Cras pretium arcu ex. Aenean posuere libero eu augue condimentum rhoncus. Praesent</p>
                                        <div class="inner">
                                            <a href="../page/blog-full-width.php" class="read-more-btn icon-space-left">Read More <span><i class="ion-ios-arrow-thin-right"></i></span></a>
                                            <div class="post-meta">
