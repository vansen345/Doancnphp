                    ...
                    <div class="table_desc">
                        <div class="table_page table-responsive">
                            <table>
                                ...
                                <?php
                                include ('connect.php');
                                $sql5 = "SELECT ct_dondat.*,dondat.*,ct_dondat.SoLuong as 'sl',dondat.TrangThai as 'tt' FROM ct_dondat JOIN dondat ON ct_dondat.MaDonDat = dondat.MaDonDat  WHERE TenDangNhap = '".$_SESSION["tendangnhap"]."' GROUP BY ct_dondat.MaDonDat ";
...
<!--                               Start Cart Single Item-->
                                <tr>
                                    ...
                                    <?php } ?>
                                    <td><a data-bs-toggle="modal" data-bs-target="#searchmadon"><i class="icon-magnifier"></i></a></td>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="modal-content" style="padding: 35px">
                            ...
                            <?php
                            $laychitietDD="SELECT sanpham.*,ct_dondat.*,ct_dondat.SoLuong as 'sl' FROM ct_dondat JOIN sanpham ON ct_dondat.MaSanPham=sanpham.MaSanPham JOIN dondat ON ct_dondat.MaDonDat = dondat.MaDonDat  WHERE TenDangNhap = '".$_SESSION["tendangnhap"]."'";
                            $truyvanlaychitietDD=mysqli_query($conn,$laychitietDD);
                            ?>
